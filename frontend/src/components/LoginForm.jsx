                ...
                <form onSubmit={handleSubmit} className="w-full">
                    <div className="mb-4">
                        ...
                        <input type="text"
                               ...
                               className="w-full px-4 py-2 rounded border border-gray-400 dark:border-zinc-500 bg-gray-200 dark:bg-zinc-600 text-black dark:text-white focus:outline-none" />
                    </div>
                    ...
                    <button type="submit"
                            className={`bg-blue-600 dark:bg-blue-600 text-white dark:text-white font-bold mt-5 px-4 py-2 w-36 rounded ${isFormValid ? 'hover:bg-blue-500' : 'cursor-not-allowed bg-opacity-75'}`}
